...
namespace GameCatalogAPI.Migrations
{
    ...
    [Migration("20250410114847_AddUserRoleAndSeed")]
            ...
            modelBuilder.Entity("GameCatalogAPI.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            PasswordHash = "$2a$11$p3GsC2UFjJRChkxWiH1tJ.AZbG7LjJ9oEV0nlys3LbaGfraeGbL3K",
                            Role = 1,
                            Username = "admin"
                        },
                        new
                        {
                            Id = 2,
                            PasswordHash = "$2a$11$2L.pBk0Q3W/D8pw58NUZqOPpTgtHYEBzhLiOyDbvrMuwuPgxpumXq",
                            Role = 0,
                            Username = "covek"
                        });
                });
